...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of JOCircularSlider.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jalal Ouraigua/JOCircularSlider'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jalal Ouraigua' => 'ouraigua@icloud.com' }
  s.source           = { :git => 'https://github.com/Jalal Ouraigua/JOCircularSlider.git', :tag => s.version.to_s }
